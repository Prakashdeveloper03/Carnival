...
# 1. MLflow setup
mlflow.set_experiment("TensorFlow Classification")
...
with mlflow.start_run() as run:
    ...
    mlflow.tensorflow.log_model(
        ...
        registered_model_name="TensorFlow-Iris-Classifier"
    )
    ...
    shap.summary_plot(shap_values, X_test[:100], feature_names=iris.feature_names, class_names=iris.target_names, show=False)
